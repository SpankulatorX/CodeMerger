...
class GenerateExtraInfoThread(QObject):
    ...
    def generate_extra_info(self):
        ...
        try:
            ...
            logging.error(f"Error in generate_extra_info method: {str(e)}")
...
class FileMergerApp(QWidget):
    ...
    def merge_files(self):
        try:
            ...
            if not self.output_file_name:
                ...
                self.merge_button.setToolTip("Ingen utdatafil vald.")
                return
    ...
    def start_generate_extra_info_thread(self):
        logging.info("Starting generate_extra_info thread")
        ...
        self.thread.finished.connect(self.on_merge_completed)
